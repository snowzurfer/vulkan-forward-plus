...
const MaterialInstance &MaterialManager::GetMaterialInstance(
...
void MaterialManager::GetMaterialConstantsBuffer(
    const VulkanDevice &device, VulkanBuffer &buffer) const {
