...
void VulkanSwapChain::InitAndCreate(
  ...
  if (vkGetPhysicalDeviceSurfaceFormatsKHR(
      ...
      nullptr) != VK_SUCCESS || surface_formats_count == 0U) {
  ...
  if (vkGetPhysicalDeviceSurfacePresentModesKHR(
      ...
      surface,
      &present_modes_count,
      nullptr) != VK_SUCCESS || present_modes_count == 0U) {
  ...
  if (vkGetSwapchainImagesKHR(
      ...
      swapchain_,
      &images_count,
      nullptr) != VK_SUCCESS || images_count == 0U) {
  ...
  for (eastl::vector<VkImage>::const_iterator i = images.begin();
    ...
    texture_manager()->CreateUniqueTexture(
        device,
        texture_init_info,
        texture_init_info.name,
        &texture);
